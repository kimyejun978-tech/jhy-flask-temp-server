...
def save_sensor(device_id):
    ...
    if (
        "current" not in data
        or
        "vibration" not in data
    ):

        return jsonify({

            "error":
            "current and vibration are required"
    ...
    try:
        ...
        return jsonify({
            ...
            "error":
            "current and vibration must be numbers"
...
def save_metal(device_id):
    ...
    # ======================================
    # JSON 또는 detected가 없는 경우
    # ======================================
    if (
        not data
        or
        "detected" not in data
    ):
