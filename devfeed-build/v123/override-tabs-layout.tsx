...
export default function TabsLayout(){
  ...
  return <Tabs screenOptions={{
    ...
    tabBarStyle:{backgroundColor:colors.card,borderTopColor:colors.line,height:56+bottom,paddingTop:6,paddingBottom:bottom},
    ...
    <Tabs.Screen name="schedule" options={{title:'일정',tabBarIcon:()=> <I e="📆"/>}} />
  </Tabs>;
}
